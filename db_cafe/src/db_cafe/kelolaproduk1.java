 ...
 * @author LIO SYAFRIZA
 */
public class kelolaproduk1 extends javax.swing.JFrame {

    /**
     * Creates new form form_kelolaproduk
     */
    public kelolaproduk1() {
        db = new db_cafe();
        db.koneksi();
        initComponents();
        showTable();
...
//       cb_produk.setEnabled(false);
    ...
    public void showTable() {
        try {
            ...
            Logger.getLogger(kelolaproduk1.class.getName()).log(Level.SEVERE, null, ex);
        }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txt_detail, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)))))
                .addContainerGap())
        );
...
//        db.del(harga);
    ...
    private void btn_changeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_changeActionPerformed
        ...
        id = txt_detail.getText();
        db.updateproduk(jumlah, id, nama, harga);
        reset();
        showTable();
    ...
    private void btn_ulangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ulangActionPerformed
        // TODO add your handling code here:
        kelolaproduk1 kp = new kelolaproduk1();
            kp.setVisible(true);
            dispose();
...
//        db.del(harga);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kelolaproduk1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kelolaproduk1().setVisible(true);
            }
        });
    }
db_cafe db;
